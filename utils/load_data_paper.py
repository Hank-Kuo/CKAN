...
def load_data(args):
    ...
    user_triple_sets = kg_propagation(args, kg, user_init_entity_set, 32, True)
    logging.info("contructing items' kg triple sets ...")
    item_triple_sets = kg_propagation(args, kg, item_init_entity_set, 32, False)

    return train_data, test_data, n_entity, n_relation, user_triple_sets, item_triple_sets
